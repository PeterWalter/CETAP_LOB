    ...
    public class DataService : IDataService
    {
        ...
        public ObservableCollection<IntakeYear> GetIntakes()
        {
            ...
            using (var context = new CETAPEntities())
            {
                ...
                if (CurrentIntake != null) CurrentYear = CurrentIntake.Year;
        ...
        public List<TestBDO> GetTestFromDatFile(datFileAttributes datafile)
        {
            ...
            using (var context = new CETAPEntities())
            {
                ...
                {
                    var di = context.TestProfiles
                             .Where(a => a.Profile == datafile.Profile && a.TestAllocation.ClientType == client)
                             .Select(v => v.TestAllocation.TestName).ToList();
                    if (di != null)
                    {
                        foreach (TestName test in di)
            ...
            if (!HelperUtils.IsFileLocked(infofile))
            {
                ...
                try
                {
                    ...
                    while (csv.Read())
                    {
                        ...
                        record.RegDate = HelperUtils.WebPrepDateTime(dor);
                        ...
                        record.CreationDate = HelperUtils.WebPrepDateTime(doc);
                        // check dates up here
        ...
        private async Task ReadFolderFilesAsync(string theFile)
        {
            ...
            ReadEasyPay Readfile = new ReadEasyPay(Filename);
            ...
            if (canAddFile)
            {
                ...
                using (CETAPEntities Manager = new CETAPEntities())
                {
                    if (Readfile.EOF.TotalTenders > 0)
                    {
                        ...
                        List<CommonLibrary.EasyPayRecord> myData = new List<CommonLibrary.EasyPayRecord>();
                        myData = Readfile.Records;
                        foreach (CommonLibrary.EasyPayRecord var in myData)
                        {
            ...
            var matched = (from b in BIO
                           ...
                           select new
                           {
                               ...
                               wroteAL = ab.AL == null ? "NO" :
                                          ab.AL == 0 ? "NO" : "YES",
                               AL_Level = ab.AL >= 84 ? "Proficient Upper" :
                                          ab.AL >= 68 ? "Proficient Lower" :
                                          ab.AL >= 54 ? "Intermediate Upper" :
                                          ab.AL >= 39 ? "Intermediate Lower" :
                                          ab.AL >= 19 ? "Basic Upper" :
                                          ab.AL > 0 ? "Basic Lower" : "",

                               QL = ab.QL == 0 ? (int?)null : ab.QL,
                               wroteQL = ab.QL == null ? "NO" :
                                          ab.QL == 0 ? "NO" : "YES",
                               QL_Level = ab.QL >= 85 ? "Proficient Upper" :
                                          ab.QL >= 70 ? "Proficient Lower" :
                                          ab.QL >= 55 ? "Intermediate Upper" :
                                          ab.QL >= 40 ? "Intermediate Lower" :
                                          ab.QL >= 20 ? "Basic Upper" :
                                          ab.QL > 0 ? "Basic Lower" : "",
                               MAT = bm.MAT != null ? (int?)bm.MAT : null,
                               //MAT = bm.MAT,
                               wroteMat = bm.MAT != null ? "YES" : "NO",
                               mat_level = bm.MAT >= 85 ? "Proficient Upper" :
                                          bm.MAT >= 69 ? "Proficient Lower" :
                                          bm.MAT >= 52 ? "Intermediate Upper" :
                                          bm.MAT >= 35 ? "Intermediate Lower" :
                                          bm.MAT >= 17 ? "Basic Upper" :
                                          bm.MAT > 0 ? "Basic Lower" : "",
                               Batch = b.BatchFile
                           }).Distinct().ToList();
        ...
        public bool AddNameToList(string name)
        {
            ...
            //    myname.Name = name;
            //    myname.DateModified = DateTime.Now;
        ...
        public bool AddSurnameToList(string surname)
        {
            ...
            using (var context = new CETAPEntities())
            {
                ...
                surn.Surname1 = surname;
                surn.DateModified = DateTime.Now;
        ...
        //public bool SaveLargeExcel(string myfile)
        //{

        //    string path = Path.GetDirectoryName(myfile);
        //    bool isgen = false;
        //    string n = " n = " + AllScores.Count() + ".xlsx";
        //    string filename = "2016 intake cycle Composite ";
        //    // Get the date today
        //    DateTime dt = new DateTime();
        //    dt = DateTime.Now;
        //    string myDay = dt.Year.ToString() + dt.Month.ToString("00") + dt.Day.ToString("00") + "_" + dt.Hour.ToString("00") + dt.Minute.ToString("00");
        ...
        //    return isgen;
        //}
        //public bool SaveLargeExcel2(string myfile)
        //{

        //    string path = Path.GetDirectoryName(myfile);
        //    bool isgen = false;
        //    string n = " n = " + AllScores.Count() + ".xlsx";
        //    string filename = "2016 intake cycle Logistics Composite ";
        //    // Get the date today
        //    DateTime dt = new DateTime();
        //    dt = DateTime.Now;
        //    string myDay = dt.Year.ToString() + dt.Month.ToString("00") + dt.Day.ToString("00") + "_" + dt.Hour.ToString("00") + dt.Minute.ToString("00");
        ...
        //    LoadNBTVenues(); // loads all venues into memory

        //    //generate a collection of Logistics objects
        //    CompositToLogisticsComposite();
        ...
        //                                                   //    new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).SessionID,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).NBTNumber,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Surname,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Name,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Initial,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).SouthAfricanID,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Passport,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Birth,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).W_AL,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).W_QL,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).W_Mat,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).StNo,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Faculty,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Programme,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).DateTest,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Venue,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Sex,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).ALScore,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).ALLevel,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).QLScore,
        //                                                   //     },
        //                                                   //     new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).QLLevel,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).MatScore,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).MatLevel,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).AQL_Lang,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).Mat_Lang,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).TestType,
        //                                                   //     },
        //                                                   //      new CellDfn
        //                                                   //    {
        //                                                   //        Value = LComposite.ElementAt(r).province,
        //                                                   //     },
